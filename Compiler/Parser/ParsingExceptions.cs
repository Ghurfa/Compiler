...
namespace Parser
{
    public abstract class ParsingException : InvalidOperationException
    {
        protected ParsingException(string message) : base(message) { }
    }
    public class UnexpectedEndOfFrameException : ParsingException
    {
        public UnexpectedEndOfFrameException()
            : base("Reached the end of the frame unexpectedly") { }
    }
    public class InvalidTokenException : ParsingException
    {
    ...
    public class InvalidStatementException : ParsingException
    {
    ...
    public class InvalidAssignmentLeftException : ParsingException
    {
        public readonly Expression Expression;
    ...
    public class InvalidIncrDecrOperand : ParsingException
    {
        public readonly Expression Expression;
