...
namespace Compiler
{
    public class CodeBlock : Statement
    {
        ...
        public override IToken LeftToken => OpenCurly;
        public override IToken RightToken => CloseCurly;

        public CodeBlock(TokenCollection tokens, OpenCurlyToken? openCurly = null, Statement[] statements = null)
        {
